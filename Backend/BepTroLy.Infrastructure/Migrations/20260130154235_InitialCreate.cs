        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserIngredients_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RecipeId = table.Column<int>(type: "int", nullable: false),
                    MatchPercent = table.Column<double>(type: "float", nullable: false),
                    MissingIngredients = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeRecommendations", x => x.RecommendationId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeRecommendations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpiryNotifications", x => x.NotificationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpiryNotifications_UserIngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeRecommendations_RecipeId",
                table: "RecipeRecommendations",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeRecommendations_UserId",
                table: "RecipeRecommendations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserIngredients_UnitId",
                table: "UserIngredients",
                column: "UnitId");
